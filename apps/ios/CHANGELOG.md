# NexisClaw iOS Changelog

## 2026.5.12 - 2026-05-12

Maintenance update for the current NexisClaw beta release.
...
Maintenance update for the current NexisClaw development release.
...
Maintenance update for the current NexisClaw release.
...
First App Store release of NexisClaw for iPhone. Pair with your NexisClaw Gateway to use chat, voice, sharing, and device actions from iOS.
