...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by NexisClaw from plugin manifests, install records, and config policy. Use `NexisClaw plugins registry --refresh`, `NexisClaw plugins install/update/uninstall`, or `NexisClaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored NexisClaw.install metadata. This describes catalog/package
