...
import type { NexisClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: NexisClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): NexisClawPluginConfigSchema {
  return {
