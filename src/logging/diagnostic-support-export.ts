...
const SUPPORT_EXPORT_PREFIX = "NexisClaw-diagnostics-";
...
function renderSummary(params: {
  ...
  return [
    ...
    "- `logs/NexisClaw-sanitized.jsonl`: sanitized log summaries and metadata",
