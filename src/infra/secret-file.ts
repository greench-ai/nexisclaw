...
import { readSecretFileSync as readSecretFileSyncImpl } from "@NexisClaw/fs-safe/secret";
...
} from "@NexisClaw/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@NexisClaw/fs-safe/secret";
