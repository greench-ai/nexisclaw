...
import { openClawRootFs, openClawRootFsSync } from "./NexisClaw-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["NexisClaw"]);
...
export async function resolveNexisClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveNexisClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
...
export const __testing = {
  clearNexisClawPackageRootCaches(): void {
