...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://NexisClaw.local")).toBe("https://NexisClaw.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://NexisClaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: NexisClaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://NexisClaw.local" },
      ...
      { Item: "Security", Value: "Run: NexisClaw security audit --deep" },
