...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "NexisClaw-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "NexisClaw-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "NexisClaw-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "NexisClaw-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "NexisClaw-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "NexisClaw-messaging-read-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "NexisClaw-legacy-state");
    const configDir = path.join("/tmp", "NexisClaw-current-config");
