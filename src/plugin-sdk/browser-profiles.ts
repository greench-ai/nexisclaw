...
import type { BrowserConfig, BrowserProfileConfig, NexisClawConfig } from "../config/config.js";
...
export const DEFAULT_NEXISCLAW_BROWSER_PROFILE_NAME = "NexisClaw";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "NexisClaw";
export const DEFAULT_BROWSER_ACTION_TIMEOUT_MS = 60_000;
export const DEFAULT_AI_SNAPSHOT_MAX_CHARS = 80_000;
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredNexisClawTmpDir(), "uploads");
