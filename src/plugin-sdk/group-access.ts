...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `NexisClaw/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `NexisClaw/plugin-sdk/channel-ingress-runtime`. */
