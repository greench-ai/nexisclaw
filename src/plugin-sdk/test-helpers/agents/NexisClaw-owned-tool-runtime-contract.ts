...
export function installNexisClawOwnedToolHooks(params?: {
 ...
 * Pair with `installNexisClawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetNexisClawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
