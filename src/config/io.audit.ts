...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.NEXISCLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.NEXISCLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.NEXISCLAW_WATCH_COMMAND),
