      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/NexisClaw.plugin.json",
        ...
        ...mockWebSearchProviders
          ...
          .map((provider) => ({
            ...
            source: "test",
            manifestPath: `/tmp/plugins/${provider.pluginId}/NexisClaw.plugin.json`,
          ...
          })),
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/acme-search/NexisClaw.plugin.json",
...
describe("web search provider config", () => {
  ...
  it("rejects installable provider ids when the plugin is not active", () => {
    ...
    expect(issue.message).toBe(
      'web_search provider is not available: brave (install or enable plugin "brave", then run NexisClaw doctor --fix)',
    );
