...
function expectNexisClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = NexisClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectNexisClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = NexisClawSchema.safeParse(config);
