...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/NexisClaw.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/NexisClaw/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/NexisClaw/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/NexisClaw/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/NexisClaw/nickserv-password.txt");
