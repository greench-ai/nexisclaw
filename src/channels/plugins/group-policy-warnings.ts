...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: NexisClawConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: NexisClawConfig }>(
  collector: WarningCollector<{ cfg: NexisClawConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: NexisClawConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: NexisClawConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: NexisClawConfig },
>(
  projectCfg: (cfg: NexisClawConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: NexisClawConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: NexisClawConfig },
>(params: {
  providerConfigPresent: (cfg: NexisClawConfig) => boolean;
