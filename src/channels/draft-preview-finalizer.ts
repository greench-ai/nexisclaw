...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `NexisClaw/plugin-sdk/channel-message`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `NexisClaw/plugin-sdk/channel-message`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `NexisClaw/plugin-sdk/channel-message`.
 */
