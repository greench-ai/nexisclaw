...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "NexisClaw:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: NexisClawConfig): AgentContextInjection {
