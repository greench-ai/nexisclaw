...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "NexisClaw-sbx-test",
    runtimeLabel: params.containerName ?? "NexisClaw-sbx-test",
    containerName: params.containerName ?? "NexisClaw-sbx-test",
