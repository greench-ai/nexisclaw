...
import {
  resolveNexisClawPluginToolInputs,
  type NexisClawPluginToolOptions,
} from "./NexisClaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveNexisClawPluginToolsOptions = NexisClawPluginToolOptions & {
...
export function resolveNexisClawPluginToolsForOptions(params: {
  options?: ResolveNexisClawPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveNexisClawPluginToolInputs({
