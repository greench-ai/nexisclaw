...
import { __testing, createNexisClawTools } from "./NexisClaw-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/NexisClaw/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./NexisClaw-plugin-tools.js", () => ({
  resolveNexisClawPluginToolsForOptions: () => [],
}));

vi.mock("./NexisClaw-tools.nodes-workspace-guard.js", () => ({
...
describe("createNexisClawTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createNexisClawTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
