...
} from "./NexisClaw-tools.subagents.sessions-spawn.test-harness.js";
import {
...
describe("NexisClaw-tools: subagents (sessions_spawn lifecycle)", () => {
  beforeEach(async () => {
  ...
  it("sessions_spawn retires bundle MCP runtime when run-mode cleanup completes", async () => {
    ...
    await getOrCreateSessionMcpRuntime({
      ...
      workspaceDir: "/tmp/NexisClaw-subagent-mcp-retire",
