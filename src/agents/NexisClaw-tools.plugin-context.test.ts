...
import { resolveNexisClawPluginToolInputs } from "./NexisClaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("NexisClaw plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveNexisClawPluginToolInputs({
      options: {
        config: {} as never,
