...
- Code: `.agents/skills/NexisClaw-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/NexisClaw-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
