...
execution:
  ...
  config:
    firstPrompt: "@NexisClaw Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@NexisClaw Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
