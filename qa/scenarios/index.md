...
- use `pnpm NexisClaw qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the NexisClaw QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this NexisClaw repo from source + docs before acting.
