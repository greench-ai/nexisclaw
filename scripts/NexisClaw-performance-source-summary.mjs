...
function printHelp() {
  console.log(`Usage: node scripts/NexisClaw-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes NexisClaw-native performance probe artifacts for CI reports.`);
}
