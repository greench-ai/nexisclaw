...
const pluginRecordSnapshot = () => {
  const config = readJson(NexisClawPath("NexisClaw.json"));
...
function seedInstallState() {
  writeJson(NexisClawPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.NEXISCLAW_CONFIG_PATH, { plugins: {} });
  writeJson(NexisClawPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by NexisClaw plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("NexisClaw will continue without it")
  );
}
