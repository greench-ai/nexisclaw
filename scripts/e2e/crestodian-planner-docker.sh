...
IMAGE_NAME="$(docker_e2e_resolve_image "NexisClaw-crestodian-planner-e2e" NEXISCLAW_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="NexisClaw-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t NexisClaw-crestodian-planner-log.XXXXXX)"
