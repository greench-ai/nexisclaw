...
if [[ -z "$version_content" ]]; then
  echo "<h2>NexisClaw $VERSION</h2>"
  echo "<p>Latest NexisClaw update.</p>"
  echo "<p><a href=\"https://github.com/NexisClaw/NexisClaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
