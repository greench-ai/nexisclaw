...
const TIMINGS_FILE_ENV_KEY = "NEXISCLAW_TEST_PROJECTS_TIMINGS_PATH";
const TIMINGS_DISABLE_ENV_KEY = "NEXISCLAW_TEST_PROJECTS_TIMINGS";
const SHARD_NAME_ENV_KEY = "NEXISCLAW_VITEST_SHARD_NAME";
