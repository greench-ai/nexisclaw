...
const rules = [
  ...
  },
  {
    ...
    moduleSpecifiers: [
      "NexisClaw/plugin-sdk/agent-dir-compat",
      "NexisClaw/plugin-sdk/channel-config-schema-legacy",
      "NexisClaw/plugin-sdk/channel-reply-pipeline",
      "NexisClaw/plugin-sdk/channel-runtime",
      "NexisClaw/plugin-sdk/compat",
      "NexisClaw/plugin-sdk/discord",
      "NexisClaw/plugin-sdk/infra-runtime",
      "NexisClaw/plugin-sdk/mattermost",
      "NexisClaw/plugin-sdk/matrix",
      "NexisClaw/plugin-sdk/telegram-account",
      "NexisClaw/plugin-sdk/testing",
      "NexisClaw/plugin-sdk/test-utils",
      "NexisClaw/plugin-sdk/zalouser",
    ],
