...
`precise.yml` is NexisClaw's shipped precise OpenGrep rulepack. Each rule is tied
...
Some NexisClaw paths are excluded by `.gitignore` for build reasons even though
