...
NexisClaw is the AI that actually does things.
...
NexisClaw started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> NexisClaw.
...
Security in NexisClaw is a deliberate tradeoff: strong defaults without killing capability.
...
NexisClaw has an extensive plugin API.
...
- Code plugins run NexisClaw plugin code and are appropriate for deeper runtime extension.
...
NexisClaw docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
NexisClaw supports MCP as both a server and a runtime integration surface.
...
NexisClaw is currently terminal-first by design.
...
NexisClaw is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep NexisClaw hackable by default.
