---
summary: "Use Qianfan's unified API to access many models in NexisClaw"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    NexisClaw onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    NexisClaw models list --provider qianfan
    ```
  </Step>
</Steps>
