---
summary: "Inworld streaming text-to-speech for NexisClaw replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In NexisClaw it
...
NexisClaw posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. NexisClaw synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    NexisClaw asks Inworld for `OGG_OPUS` so the audio plays as a native
