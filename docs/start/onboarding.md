---
summary: "First-run setup flow for NexisClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give NexisClaw">
...
<Step title="CLI">
  ...
  The app can install the global `NexisClaw` CLI via npm, pnpm, or bun.
