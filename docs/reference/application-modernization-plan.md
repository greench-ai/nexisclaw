...
read_when:
  - Planning a broad NexisClaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local NexisClaw skill,
create `.agents/skills/NexisClaw-frontend/SKILL.md` first, keep the frontmatter
