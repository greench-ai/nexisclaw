...
function mergeSignalAccountConfig(cfg: NexisClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: NexisClawConfig): ResolvedSignalAccount[] {
