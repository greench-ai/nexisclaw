...
// steer NexisClaw-managed Claude CLI runs toward a different provider,
...
function isNexisClawRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isNexisClawRequestedYolo(context)
