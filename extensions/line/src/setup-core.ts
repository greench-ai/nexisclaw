import type { ChannelSetupAdapter, NexisClawConfig } from "NexisClaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "NexisClaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: NexisClawConfig, accountId: string): boolean {
