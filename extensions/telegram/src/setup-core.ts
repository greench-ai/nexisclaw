import type { ChannelSetupAdapter } from "NexisClaw/plugin-sdk/setup-runtime";
import {
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://NexisClaw.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("NexisClaw logs --follow")}\` (safest)`,
