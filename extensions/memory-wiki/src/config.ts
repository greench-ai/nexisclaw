...
import { buildPluginConfigSchema, z, type NexisClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: NexisClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".NexisClaw", "wiki", "main");
}
