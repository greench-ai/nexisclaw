...
import {
  ...
  sessionPathForFile,
} from "nexusclaw/plugin-sdk/memory-core-host-engine-qmd";
...
import { appendRegularFile, privateFileStore } from "nexusclaw/plugin-sdk/security-runtime";
...
type Logger = Pick<NexusClawPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__nexusclaw_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__nexusclaw_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- nexusclaw:dreaming:light:start -->",
    endMarker: "<!-- nexusclaw:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- nexusclaw:dreaming:rem:start -->",
    endMarker: "<!-- nexusclaw:dreaming:rem:end -->",
  },
] as const;
