...
import { createAsyncLock } from "nexusclaw/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "nexusclaw/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "nexusclaw/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "nexusclaw/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
} from "nexusclaw/plugin-sdk/session-store-runtime";
...
const DIARY_START_MARKER = "<!-- nexusclaw:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- nexusclaw:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "nexusclaw:dreaming:backfill-entry";
