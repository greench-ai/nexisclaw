...
import type {
  ...
  MessageEventContent,
} from "@NexisClaw/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@NexisClaw/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } =
    await import("NexisClaw/plugin-sdk/qa-runner-runtime");
