...
// Deprecated compatibility surface for existing @NexisClaw/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "NexisClaw/plugin-sdk/runtime-group-policy";
