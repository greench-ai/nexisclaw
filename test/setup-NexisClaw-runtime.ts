...
const WORKER_RUNTIME_STATE = Symbol.for("NexisClaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("NexisClaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("NexisClaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: NexisClawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
