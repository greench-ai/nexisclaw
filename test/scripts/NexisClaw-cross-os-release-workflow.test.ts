...
const WORKFLOW_PATH = ".github/workflows/NexisClaw-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-NexisClaw-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-NexisClaw-cross-os-release-checks.sh";
