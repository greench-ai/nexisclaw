...
import {
  ...
  type NexisClawTestStateOptions,
} from "../../src/test-utils/NexisClaw-test-state.js";
import { sleep } from "../../src/utils.js";

export type NexisClawTestInstanceOptions = {
  name: string;
  cwd?: string;
  port?: number;
  gatewayToken?: string;
  ...
  state?: Omit<NexisClawTestStateOptions, "applyEnv" | "gateway" | "env">;
  gatewayArgs?: string[];
  startTimeoutMs?: number;
  stopTimeoutMs?: number;
};

export type NexisClawTestInstanceCommandResult = {
  code: number | null;
...
export type NexisClawTestInstance = {
  name: string;
  port: number;
  url: string;
  hookToken: string;
  ...
  ) => Promise<NexisClawTestInstanceCommandResult>;
...
export async function createNexisClawTestInstance(
  options: NexisClawTestInstanceOptions,
): Promise<NexisClawTestInstance> {
  ...
  const instance: NexisClawTestInstance = {
    name: options.name,
    port,
